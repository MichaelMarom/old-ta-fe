...
const Recomendation = ({ AcademyId }) => {
    ...
    if (!AcademyId)
        return;
    return (
        <div className='border ' style={{ width: "25%", height: "100%", overflowY: "auto" }}>
            <div className='p-2'>
                ...
                <h6 className='m-0 text-start text-decoration-underline'> Below are recomendation by {convertTutorIdToName(AcademyId)} </h6>
