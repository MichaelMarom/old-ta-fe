...
import DegreeModal from "../../components/admin/DegreeModal";
import { getDoc, updateTutorSetup } from "../../axios/tutor";
import StatusReason from "../../components/admin/StatusReason";
...
const TutorTable = () => {
    ...
    const handleProceed = async (e) => {
        ...
        emitSocketNotification('notif_incoming',
            ...
            `Your profile status is ${selectedStatus}`,
            "admin",
            user.email
        )
