...
const ShortlistAdCard = ({ photo, name, adText, id, setAdDeleted, tutorId, subject, country }) => {
            ...
            <div className='d-flex border p-2 align-items-center rounded-4  flex-column position-relative m-1 text-light' style={{ background: "gray" }}>
                ...
                <div className='mt-2'>
                    <TAButton buttonText={'See Profile'} style={{ width: "150px" }}
                        handleClick={() => window.open(`${process.env.REACT_APP_BASE_URL}/student/tutor-profile/${tutorId}`, '_blank')} />
                </div>
            </div>
        </div>
    )
