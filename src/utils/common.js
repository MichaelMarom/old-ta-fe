...
export const unsavedChangesHelper = (fieldValues, tutor) => {
  return (
    ...
    (tutor.Address1 !== undefined &&
      fieldValues.add1 !== undefined &&
      tutor.Address1 !== fieldValues.add1) ||
    (tutor.Address2 !== undefined &&
      fieldValues.add2 !== undefined &&
      tutor.Address2 !== fieldValues.add2) ||
    (tutor.CellPhone !== undefined &&
      fieldValues.cell !== undefined &&
      tutor.CellPhone !== fieldValues.cell) ||
    (tutor.CityTown !== undefined &&
      fieldValues.city !== undefined &&
      tutor.CityTown !== fieldValues.city) ||
    (tutor.Country !== undefined &&
      fieldValues.country !== undefined &&
      tutor.Country !== fieldValues.country) ||
    (tutor.FirstName !== undefined &&
      fieldValues.fname !== undefined &&
      tutor.FirstName !== fieldValues.fname) ||
    (tutor.GMT !== undefined &&
      fieldValues.timeZone !== undefined &&
      tutor.GMT !== fieldValues.timeZone) ||
    (tutor.Grades !== undefined &&
      fieldValues.tutorGrades !== undefined &&
      !isArrayStringEqual(fieldValues.tutorGrades, tutor.Grades)) ||
    (tutor.HeadLine !== undefined &&
      fieldValues.headline !== undefined &&
      tutor.HeadLine !== fieldValues.headline) ||
    (tutor.Introduction !== undefined &&
      fieldValues.intro !== undefined &&
      tutor.Introduction !== fieldValues.intro) ||
    (tutor.LastName !== undefined &&
      fieldValues.lname !== undefined &&
      tutor.LastName !== fieldValues.lname) ||
    (tutor.MiddleName !== undefined &&
      fieldValues.mname !== undefined &&
      tutor.MiddleName !== fieldValues.mname) ||
    (tutor.Motivate !== undefined &&
      fieldValues.motivation !== undefined &&
      tutor.Motivate !== fieldValues.motivation) ||
    (tutor.ResponseHrs !== undefined &&
      fieldValues.response_zone !== undefined &&
      tutor.ResponseHrs !== fieldValues.response_zone) ||
    (tutor.StateProvince !== undefined &&
      fieldValues.state !== undefined &&
      tutor.StateProvince !== fieldValues.state) ||
...
export const compareStates = (dbState, currentState) => {
  ...
  for (const key in currentState) {
    ...
    if (
      ...
      moment(currentState["CertificateExpiration"]).isSameOrBefore(
        moment(),
        "day"
      )
    )
      continue;
    if (
      _.isObject(currentState[key]) &&
      currentState[key] !== undefined &&
      !_.isEqual(currentState[key], dbState[key])
    )
      return true;
...
export const generateUpcomingSessionMessage = (session, fromNow) => {
  return session?.id
    ? `The next lessson (${session.subject}) starting in ${fromNow}`
    : "";
};
...
export const checkSessionStatus = (session, timezone) => {
